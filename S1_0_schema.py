...
class ScenarioConfig:
    # Legacy defaults are intentionally preserved.  Thermal-stress runs create
    # an explicit expanded config in S4_0_main instead of changing every run.
    years_hist_start: int = 2010
    years_hist_end: int = 2020
    years_future: List[int] = field(default_factory=lambda: [2080])
